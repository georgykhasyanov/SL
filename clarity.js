...
;(function () {
  ...
  const uid = queryUid || (parentClarityQueryData && parentClarityQueryData.uid) || cookieUid || "W4mL1ukCQ8WnGlEE7CD9T79geMHqUAlT";
  const sid = (parentClarityQueryData && parentClarityQueryData.sid) || cookieSid || "bHKKzP0IgxV99MExD6Ajm7NcdvF5wkuU:1782202730187";
  ...
  function trackBehaviour() {
    ...
    const browserSessionId = sessionStorage.getItem('clrt-v8-session-id') || "8Z623T-Ag-9kBqV86Q5bVcNcnlZhYS_n";
